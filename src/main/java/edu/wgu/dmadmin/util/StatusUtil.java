...
public class StatusUtil {
	...
	public static final String AUTHOR_WORK_NEEDS_REVISION = "16"; //submission able to be resubmitted (unlocked)
	...
	public static boolean isInEvaluation(String status) {
		return (EVALUATION_BEGUN.equals(status) || EVALUATION_TAKEN_OVER.equals(status) || EVALUATION_EDITED.equals(status));
	}
	...
	public static boolean isReviewing(String status) {
		return EVALUATION_EDITED.equals(status);
	}
	
	public static boolean canAssign(String status) {
		return (AUTHOR_WORK_SUBMITTED.equals(status) || AUTHOR_WORK_RESUBMITTED.equals(status)
				|| EVALUATION_CANCELLED.equals(status) || EVALUATION_BEGUN.equals(status));
	}
	...
	public static boolean isLocked(String status) {
		return AUTHOR_WORK_EVALUATED.equals(status);
	}
