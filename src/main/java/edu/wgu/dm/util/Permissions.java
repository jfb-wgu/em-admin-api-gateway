...
public class Permissions {
    ...
    public static final String VIEW_ALL_TASK = "view-all-task";
    public static final String EDIT_DRAFT_TASK = "edit-draft-task";
    public static final String EDIT_PUBLISHED_TASK = "edit-published-task";
    public static final String CREATE_ASSESSMENT = "create-assessment";
